...
Plotly.plot = function(gd, data, layout, config) {
    ...
    // container, log a warning to help plotlyjs users debug
    ...
    // hook class for plots main container (in case of plotlyjs
...
// convenience function to force a full redraw, mostly for use by plotlyjs
...
function plotAutoSize(gd, aobj) {
    ...
    if(gd._context.fillFrame) {
        ...
        // plotlyjs - let the developers do what they want, either
